...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        a1_effect_mutex = set(node_a1.action.effect_add).intersection(set(node_a2.action.effect_rem))
        a2_effect_mutex = set(node_a2.action.effect_add).intersection(set(node_a1.action.effect_rem))
        return a1_effect_mutex or a2_effect_mutex
